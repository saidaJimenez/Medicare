...
const Login = () => {
  ...
  return  <section className="px-5 lg:px-0">
    ...
    <h3 className="text-headingColor text-[22px] leading-9 font-bold mb-10">Hola! <span
    ...
    <div className="mb-5">
      ...
      <p className="mt-5 textColor text-center">
       No tengo cuenta <Link to='/register' className="text-primaryColor font-medium ml-1">Registrarte</Link>
      </p>
    </form>
    </div>
  </section>
